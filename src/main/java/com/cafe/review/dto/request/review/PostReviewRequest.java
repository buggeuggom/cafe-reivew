...
public class PostReviewRequest {
    ...
    @Builder
    private PostReviewRequest(Long directionId, String writerId, String password, String title, String comment, Integer tasteRating, Integer ambienceRating, Integer serviceRating) {
