...
public class ReviewController {
    ...
    public PostReviewResponse post(@PathVariable Long cafeId, @RequestBody PostReviewRequest request) {

        return PostReviewResponse.fromDto(reviewService.post(cafeId, request));
    }

    @PutMapping("/reviews/{reviewId}")
    public void put(@PathVariable Long reviewId, @RequestBody PutReviewRequest request) {
        reviewService.edit(reviewId, request);

    }

    @PostMapping("/reviews/{reviewId}/delete")
    public void delete(@PathVariable Long reviewId, @RequestBody DeleteReviewRequest request) {
